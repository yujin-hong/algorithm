...
int main() {
    ...
    for(int k=0;k<tc_num;k++) {
        ...
        map<int, long long> sum_map;
        map<pair<int, int>, long long> sum_for_minus;
        set<int> s;
        vector<int> index;
        int len;
        cin>>len;
        ...
        for(auto it = s.begin(); it != s.end(); it++){
            ...
            for(int j=0;j<tmp.size();j++) {
                ...
                sum_for_minus[make_pair(val, j+1)] = tmp_sum;
            }
	    }
        for(int i=1;i<=len;i++) {
            ...
            for(auto it = s.begin(); it != s.end(); it++){
                ...
                if(count_map[val]/i >= 1) {
                    ...
                    minus_num = minus_num + sum_for_minus[make_pair(val, should_minus_num_count)];
                }             
            }
